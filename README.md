...
RoomNest is a console-based hostel management system built with C++ and file handling, designed to streamline room allocation and reservation tracking for hostels.
